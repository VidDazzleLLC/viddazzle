-- Railway pgvector Database Schema
-- Run this in Railway's PostgreSQL Query Editor
...
CREATE TRIGGER update_tutorial_embeddings_updated_at
  BEFORE UPDATE ON tutorial_embeddings
  FOR EACH ROW
  EXECUTE FUNCTION update_updated_at_column();
